          ...
          <div className="container mx-auto px-6 md:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-gray-800 rounded-lg p-6 transform hover:scale-105 transition-transform duration-300">
                <h4 className="text-xl font-bold">PDF Chat with Gemini</h4>
                <p className="mt-2">Google Gemini AIのFile Search APIを活用したPDFチャットアプリケーションです。Streamlitで構築された対話型インターフェースを通じて、ユーザーはPDFファイルの内容について質問できます。</p>
                <div className="mt-4">
                  <a href="https://geminifilesearchtool-clkptuzq729usonxezsvg2.streamlit.app/" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline mr-4">View App</a>
                  <a href="https://github.com/holys519/gemini_file_search_tool" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">GitHub</a>
                </div>
              </div>
              <div className="bg-gray-800 rounded-lg p-6 transform hover:scale-105 transition-transform duration-300">
